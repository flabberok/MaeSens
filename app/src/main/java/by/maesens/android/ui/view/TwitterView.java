...
/**
 * Created by Igor Paliashchuk on 19.03.16.
 * View for sharing project information with Twitter.
 */
public class TwitterView extends TextView {
    ...
    private void init(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP)
            logoDrawable = getResources().getDrawable(R.drawable.ic_twitter, null);
        else
            logoDrawable = getResources().getDrawable(R.drawable.ic_twitter);
